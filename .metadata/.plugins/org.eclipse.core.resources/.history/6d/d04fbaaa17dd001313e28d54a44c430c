...
public class GameServer {
    ...
    public static boolean registerClient(String username, String password) {
        //try {
        // database.update("INSERT INTO tblUsers (`name`, `password`) VALUES ('" + username + "', '" + password + "');");
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    if (typeClient.equalsIgnoreCase("GameClient")) {//Game Client
                        ...
                        for (int i = 0; i < listData.size(); i++) {
                            if (listData.get(i).username.toLowerCase().equals(username.toLowerCase())) {
                                accepted = false;
                                break;
                            }
                        ...
                        if (checkLogin(username, password)) {//checks in database if the login was succesful
                            if (accepted) {

                                oos.writeObject("Welcome to this server...");
                                listClientsModel.addElement(username + " - " + socket.getInetAddress().getHostAddress() + " - " + socket.getInetAddress().getHostName());
                    ...
                    } else if (typeClient.equalsIgnoreCase("RegisterClient")) {//Registering
